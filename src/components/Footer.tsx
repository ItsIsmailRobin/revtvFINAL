...
export default function Footer() {
  ...
  return (
    <footer className="footer-root px-1 pb-4 pt-3">
      {/* Desktop: clock left, credits right */}
      <div className="hidden lg:flex items-center justify-between gap-4">
        {/* Clock pill */}
        <div
          className="footer-clock inline-flex cursor-default items-center gap-1.5 rounded-full border border-white/10 bg-white/[0.03] px-3 py-1 backdrop-blur-md"
        ...
        >
          ...
          <span style={{ fontSize: "10.5px", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em", color: "rgba(255,255,255,0.55)" }}>
            TIME
          </span>
          <span className="h-2.5 w-px bg-white/15" />
          <span className="font-mono tabular-nums" style={{ fontSize: "10.5px", fontWeight: 500, color: "rgba(255,255,255,0.80)", fontVariantNumeric: "tabular-nums", lineHeight: 1 }}>
            {time}
          </span>
          <span style={{ fontSize: "10.5px", fontWeight: 600, textTransform: "uppercase", color: "rgba(255,255,255,0.55)" }}>
            {ampm}
          </span>
        </div>
        ...
        <div className="flex flex-col items-end gap-1">
          ...
          <div className="flex items-center gap-1.5" style={{ color: "rgba(255,255,255,0.22)" }}>
            ...
            <a href="https://discord.gg/EttmFjhhq5" target="_blank" rel="noopener noreferrer"
              className="group flex items-center gap-1 transition-colors duration-300 hover:text-white/70">
              ...
              <span style={{ fontSize: "11.5px", textTransform: "uppercase", letterSpacing: "0.18em", fontWeight: 500 }}>NoScope eSports</span>
            </a>
          </div>
        </div>
      </div>

      {/* Mobile: clock only (left-aligned), footer credits go all the way down via App.tsx */}
...
export function FooterCredits() {
  return (
    <div className="flex flex-col items-center gap-1 py-4 mt-2" style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }}>
      <div className="group flex cursor-default items-center gap-1.5 transition-colors duration-300"
        style={{ color: "rgba(255,255,255,0.28)" }}>
        <span style={{ fontSize: "11.5px", textTransform: "uppercase", letterSpacing: "0.18em", fontWeight: 500 }}>Created By</span>
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
