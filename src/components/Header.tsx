      ...
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-1.5 pl-1">
          ...
          <span
            ...
            style={{ fontSize: "12px", color: "#ffffff", fontFamily: "'Space Grotesk','Space Grotesk Fallback',sans-serif", fontVariantNumeric: "tabular-nums", lineHeight: 1 }}
          >
            {bdClock.time}
          </span>
          <span
            className="font-semibold uppercase tracking-widest"
            style={{ fontSize: "11px", color: "rgba(255,255,255,0.6)", fontFamily: "'Space Grotesk','Space Grotesk Fallback',sans-serif", lineHeight: 1 }}
          >
            {bdClock.ampm}
          </span>
        </div>
